...
import com.sharif.foodandnutrition.databinding.ActivitySignInBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.signIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                  progressDialog.show();
                  auth.signInWithEmailAndPassword(binding.gmail.getText().toString(),binding.password.getText().toString())
